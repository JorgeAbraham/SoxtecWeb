    ...
    <div class="dh">
        ...
        <div class="et bmj">
            ...
            <jsp:include page="../menuSuperior.jsp" flush="true"/>
                    ...
                    <form id="crearOrdenDePago" action="Servlet?controlador=registraPagoPendiente" method = "post"  enctype = "multipart/form-data">
                        ...
                        String requisicionesForm[][]=operacion.listaOperacionesBasePorTipo("7");
                        ...
                        for (int i=0;i<requisicionesForm.length;i++){
                            ...
                            if (  requisicionesForm[i][2]==null  ){  //No es una Lista
                                ...
                                if (requisicionesForm[i][3].equals(operaciones_servicio.tipoNumero)){
                                    ...
                                    plantillaDeTexto=plantillaDeTexto+"<span class=\"col-md-6\">"+requisicionesForm[i][1]+"</span>";
                                    plantillaDeTexto=plantillaDeTexto+"<input type=\"text\" name=\""+requisicionesForm[i][4]+"\" id=\""+requisicionesForm[i][4]+"\"   class=\"col-md-6\" value=\"0.0\"  onkeyup=\"formatoNumerico(event);\"    >";
                                ...
                                if (requisicionesForm[i][3].equals(operaciones_servicio.catalogo)){
                                    ...
                                    if (requisicionesForm[i][4].equals("PersonaReceptora")){
                                        ...
                                        plantillaDeTexto=plantillaDeTexto+"<div class=\"form-group col-md-6\">"+
                                                                                "<select name=\""+requisicionesForm[i][4]+"\" class=\"form-control\">"+
                                                                                    "<option value=\"\"></option>"+
                                                                                    opciones+
                                                                                "</select>"+
                                                                            "</div>";
...
<script>
    ...
    function actualizarBotonCabecera(){
        window.location='Servlet?controlador=crearPagoPendiente';  
    } 


    function validacion() {
        
        var desc = document.getElementById("descripcionOrdenPago").value;
        var monto = document.getElementById("montoSolicitadoOrdenesPago").value;
        ...
        if (monto == ''  || monto == '0.0'  ){
            valido=0;
            alert("Por favor llena la Monto");
        }
        
        if (valido==1){
            document.getElementById("crearOrdenDePago").submit();
        }
