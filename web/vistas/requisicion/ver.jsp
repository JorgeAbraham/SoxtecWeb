        ...
        <div class="et bmj">
            ...
            <jsp:include page="../menuSuperior.jsp" flush="true"/>
                    ...
                    <form id="" action="Servlet?controlador=crearOrdenDeCompra" method = "post"  enctype = "multipart/form-data">
                        ...
                        requisicionesForm=operacion.listaOperacionesRelacionadasPorTipoOperacion(idOperacion,"1");
                        ...
                        for (int i=0;i<requisicionesForm.length;i++){
                            ...
                            if (  requisicionesForm[i][6]==null  ){  //No es una Lista
                                ...
                                if (requisicionesForm[i][8].equals(operaciones_servicio.catalogo)){
                                    ...
                                    plantillaDeTexto=plantillaDeTexto+"<span class=\"col-md-6\">"+requisicionesForm[i][7]+ "</span>";
                                    if (requisicionesForm[i][14].equals("UsuarioApruebaRechaza")){
                                        if( requisicionesForm[i][9]!=null &&  !requisicionesForm[i][9].equals("")){ 
                                            persona_servicio empleados = new persona_servicio();
                                            empleados.setIdPersona(Integer.parseInt(requisicionesForm[i][9]));
                                            empleados.get();
                        ...
                        operacion = new operaciones_servicio();
                        requisicionesForm=operacion.listaOperacionesRelacionadasPorTipoOperacion(idOperacion,"2");
                        ...
                        for (int i=0;i<requisicionesForm.length;i++){
                            ...
                            if (  requisicionesForm[i][6]==null  ){  //No es una Lista
                                ...
                                if (requisicionesForm[i][8].equals(operaciones_servicio.catalogo)){
                                    ...
                                    plantillaDeTexto=plantillaDeTexto+"<span class=\"col-md-6\">"+requisicionesForm[i][7]+ "</span>";
                                    if (requisicionesForm[i][14].equals("UsuarioAplicado")){
                                        if( requisicionesForm[i][9]!=null &&  !requisicionesForm[i][9].equals("")){ 
                                            persona_servicio empleados = new persona_servicio();
                                            empleados.setIdPersona(Integer.parseInt(requisicionesForm[i][9]));
                                            empleados.get();
                        ...
                        operacion = new operaciones_servicio();
                        requisicionesForm=operacion.listaOperacionesRelacionadasPorTipoOperacion(idOperacion,"4");
                        ...
                        for (int i=0;i<requisicionesForm.length;i++){
                            ...
                            if (  requisicionesForm[i][6]==null  ){  //No es una Lista
                                ...
                                if (requisicionesForm[i][8].equals(operaciones_servicio.catalogo)){
                                    ...
                                    plantillaDeTexto=plantillaDeTexto+"<span class=\"col-md-6\">"+requisicionesForm[i][7]+ "</span>";
                                    if (requisicionesForm[i][14].equals("UsuarioApruebaRechazaComprobacion")){
                                        if( requisicionesForm[i][9]!=null &&  !requisicionesForm[i][9].equals("")){ 
                                            persona_servicio empleados = new persona_servicio();
                                            empleados.setIdPersona(Integer.parseInt(requisicionesForm[i][9]));
                                            empleados.get();
...
<div id="procesarComprobante" class="cb fade" tabindex="-1" role="dialog" aria-labelledby="bmp">  
   <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="" action = "Servlet?controlador=procesarComprobanteCompra" method = "post" >
                ...
                <div class="om">
                    <input type="submit" class="btn btn-md btn-danger" onclick="seleccionaEstadoComprobacion(8)" value = "Denegar" /> <!-- Rechazado -->
                    <input type="submit" class="btn btn-md btn-success" onclick="seleccionaEstadoComprobacion(7)" value = "Aprobar" /> <!-- Aprobado -->
                </div>
            </form>
        </div>
    </div>
...
<div id="procesar" class="cb fade" tabindex="-1" role="dialog" aria-labelledby="bmp">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="" action = "Servlet?controlador=procesarOrdenCompra" method = "post" >
                <div class="modal-body">
                ...
                <div class="om">
                     <input type="submit" class="btn btn-md btn-danger" onclick="seleccionaEstado(4)" value = "Denegar" /> <!-- Rechazado -->
                     <input type="submit" class="btn btn-md btn-success" onclick="seleccionaEstado(3)" value = "Aprobar" /> <!-- Aprobado -->
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    function actualizarBotonCabecera(){
        window.location='Servlet?controlador=verRequisicion&numeroOperacion=<%out.print(idOperacion);%>';  
    } 
