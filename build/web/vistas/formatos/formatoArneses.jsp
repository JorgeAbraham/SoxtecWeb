        ...
        <div class="et bmj">
            ...
            <jsp:include page="../menuSuperior.jsp" flush="true"/>
                    ...
                    <div class="bkz aav aaj">
                        <h3 class="bla blb">Formato de revisión de Arneses</h3>
                    </div>
                    ...
                    <form id="crearRegistroFormato" action="Servlet?controlador=crearRegistroFormatoArnes" method = "post"  enctype = "multipart/form-data">
                        ...
                        <%
                           ...
                           String catalogoZona[][]=catalogo.listaCatalogoPorTipo("9");
                           ...
                           String catalogoLinea[][]=catalogo.listaCatalogoPorTipo("7");
                           String Linea="";
                           for (int i=0;i<catalogoLinea.length;i++){
                               Linea=Linea+"<option value=\'"+catalogoLinea[i][1]+"\'>"+catalogoLinea[i][1]+"</option>";
                           }
                          
                           String catalogoDefectos[][]=catalogo.listaCatalogoPorTipo("8");
                           String Defectos="";
                        ...
                        String requisicionesForm[][]=operacion.listaOperacionesBasePorTipo("16");
                        ...
                        for (int i=0;i<requisicionesForm.length;i++){
                            ...
                            if (  requisicionesForm[i][2]==null  ){  //No es una Lista
                                ...
                                if (requisicionesForm[i][3].equals(operaciones_servicio.tipoTexto)){
                                    ...
                                    plantillaDeTexto=plantillaDeTexto+"<input type=\"text\" name=\""+requisicionesForm[i][4]+"\"  id=\""+requisicionesForm[i][4]+"\"  class=\"col-md-4\"   onkeypress=\"pulsar(event,'"+requisicionesForm[i][4]+"')\"   >";
                                    plantillaDeTexto=plantillaDeTexto+"<a href='javascript:;' class=\"col-md-2 btn btn-white btn-md bla blb \" onclick=\"borrar('"+requisicionesForm[i][4]+"');\" ><i class=\"fa fa-remove\" ></i> </a>";
                                ...
                                if (requisicionesForm[i][3].equals(operaciones_servicio.catalogo)){
                                    ...
                                    if (requisicionesForm[i][4].equals("TurnoInspeccionArnes")){
                                    ...
                                    if (requisicionesForm[i][4].equals("LineaInspeccionArnes")){
                                        plantillaDeTexto=plantillaDeTexto+"<div class=\"form-group col-md-6\">"+
                                            "<select id=\""+requisicionesForm[i][4]+"\" name=\""+requisicionesForm[i][4]+"\" class=\"form-control\">"+
                                                "<option value=\"\"></option>"+
                                                Linea+
                                    ...
                                    if (requisicionesForm[i][4].equals("inspectorArnes")){
                                    ...
                                    if (  requisicionesForm[j][2]!=null  &&   requisicionesForm[j][2].equals(idLista)){
                                        valores=valores+"<td>";
                                            ...
                                            if (requisicionesForm[j][3].equals(operaciones_servicio.catalogo)){
                                                ...
                                                if (requisicionesForm[j][4].equals("ZonaDefectoArnes")){
                                                ...
                                                if (requisicionesForm[j][4].equals("DefectoArnes")){
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <%
                                        ...
                                        String formatoRevision[][]=formatoServicio.listaRevisionesDeArnes(idUsuario);
...
<script>
    ...
    function actualizarBotonCabecera(){
        window.location='Servlet?controlador=formatoRevisionArneses';  
    } 
    ...
    function pulsar(e,nombreHTML) {
        
        
        
        
        if ( e.keyCode === 13 ) {
            if (nombreHTML == 'VINArnes'){
                document.getElementById("NumeroPartearnesInspeccionArnes").focus();
            }
            if (nombreHTML == 'NumeroPartearnesInspeccionArnes'){
                document.getElementById("SerieArnes").focus();
            }
        }
    }   
    ...
    $(document).ready(function(){
        ...
        document.getElementById("VINArnes").focus();
    ...
    function new_clock(){ 
        ...
        document.getElementById("HoraInspeccionArnes").value = print_clock;
    ...
    function validacion() {
        ...
        var TurnoInspeccion = document.getElementById("TurnoInspeccionArnes").value;
        ...
        var LineaInspeccion = document.getElementById("LineaInspeccionArnes").value;
        ...
        var NumeroPartePuertaInspeccion = document.getElementById("NumeroPartearnesInspeccionArnes").value;
        ...
        for (var i = 1; i <= numeroFilas ; i++) { 
            ...
            defecto=document.getElementById("DefectoArnes_"+i).value ;  
                ...
                if (  requisicionesForm[i][2]!=null  &&   requisicionesForm[i][2].equals(idLista)){
                    ...
                    out.println("var cell"+numeroColumna+" = row.insertCell("+numeroColumna+");");
                        ...
                        if (requisicionesForm[i][3].equals(operaciones_servicio.catalogo)){
                            ...
                            if (requisicionesForm[i][4].equals("ZonaDefectoArnes")){
                            ...
                            if (requisicionesForm[i][4].equals("DefectoArnes")){
    ...
    function borrar(nombreHTML) {
        
       var valor="";
       document.getElementById(nombreHTML).value=valor;
       document.getElementById(nombreHTML).focus();
